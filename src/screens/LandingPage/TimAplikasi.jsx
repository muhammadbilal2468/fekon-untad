    ...
    <>
      ...
      <div className="max-w-screen-xl mx-auto p-4">
        ...
        <div className="flex justify-center xl:gap-16 gap-4">
          <div class="w-1/2 max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-md shadow-primary">
            <div class="flex flex-col items-center p-6">
              <img
                class="w-36 xl:h-46 mb-3 rounded-t-xl shadow-lg"
                src={bilalImg}
                alt="Muhammad Bilal"
              />
              <h5 class="mb-1 xl:text-2xl text-sm text-center font-medium text-gray-900">
                Muhammad Bilal
              </h5>
              <span class="xl:text-lg text-xs text-center text-gray-500">
                S1 Teknik Informatika
              </span>
              <div class="flex xl:flex-row flex-col mt-4 md:mt-6 xl:gap-3 gap-2">
                <a
                  href="https://www.linkedin.com/in/muhammad-bilal-314888221/"
                  class="inline-flex items-center p-2 text-sm font-medium text-center text-primary border rounded-lg gap-2 w-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="xl:w-6 w-4 xl:h-6 h-4"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-primary xl:text-lg text-xs">Connect</p>
                </a>
                <a
                  href=" "
                  class="inline-flex items-center p-2 text-sm font-medium text-center text-primary border rounded-lg gap-2 w-full"
                >
                  ...
                  <p className="text-primary xl:text-lg text-xs">Follow</p>
                </a>
              </div>
            </div>
          </div>
