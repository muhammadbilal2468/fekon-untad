...
const Beranda = () => {
  return (
    <>
      <div className="flex gap-10 flex-row items-center h-[80vh]">
          ...
          <div className="flex flex-col items-center basis-1/3 border rounded-md p-3 shadow-xl border-none pb-10">
            ...
            <div className="flex items-center justify-center gap-10">
              ...
              >
                <path
                  fill="#1E429F"
                  d="M15.09 12.79a1 1 0 0 0-.086-1.638L15 5.33L14 6v5.15a1.001 1.001 0 0 0-.092 1.629l-.378.502a2.48 2.48 0 0 0-.53 1.498v1.222h.815a.88.88 0 0 0 .853-.664l.331-1.336v2h1v-1.21a2.486 2.486 0 0 0-.534-1.505zM8 0L0 4l8 5l8-5z"
                />
                <path
                  fill="#1E429F"
      ...
      <div className="flex gap-32 mb-20">
        <div className="">
          ...
          <p className="text-lg">
            Jalan Untad 1 No.9, Universitas Tadulako, Kelurahan Tondo, Kec.
            Mantikulore, Kota Palu, Sulawesi Tengah 94148
          </p>
        </div>
        <div className="flex flex-col justify-center items-center w-1/2">
          <h2 className="text-3xl font-bold mb-16 text-center">HUBUNGI KAMI</h2>
